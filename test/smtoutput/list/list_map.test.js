...
describe ("SMT List -- map basic", () => {
    it("should do simple maps", function () {
        runishMainCodeUnsat('public function main(): Nat { return List<Int>{}.map<Bool>(fn(x) => x >= 0i).size(); }', "(assert (not (= #x00 Main@main)))");
    ...
    it("should do simple maps w/err", function () {
        runishMainCodeUnsat('public function main(): Nat { return List<Int>{}.map<Bool>(fn(x) => { assert x != 0i; return x >= 0i; }).size(); }', "(assert (not (= (@Result-ok #x00) Main@main)))");
...
describe ("SMT List -- map index basic", () => {
    it("should do simple maps index", function () {
        runishMainCodeUnsat('public function main(): Nat { return List<Nat>{}.mapIdx<Bool>(fn(x, i) => x >= i).size(); }', "(assert (not (= #x00 Main@main)))");
        ...
        runishMainCodeUnsat('public function main(): Nat { return List<Int>{1i, -1i, 3i}.mapIdx<Nat>(fn(x, i) => i).back(); }', "(assert (not (= (@Result-ok #x02) Main@main)))");
    });

    it("should do simple maps index w/err", function () {
        runishMainCodeUnsat('public function main(): Nat { return List<Nat>{}.mapIdx<Bool>(fn(x, i) => { assert x != 0n; return x >= i; }).size(); }', "(assert (not (= (@Result-ok #x00) Main@main)))");
        ...
        runishMainCodeUnsat('public function main(): Nat { return List<Int>{1i, -1i, 3i}.mapIdx<Nat>(fn(x, i) => { assert x != 0i; return i; }).back(); }', "(assert (not (= (@Result-ok #x02) Main@main)))");
    });
});
